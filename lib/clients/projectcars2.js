...
class ProjectCars2 extends AbstractClient {
  ...
  showTyreTemp = (onRight) => {
    ...
    const tyreTemps =
      this.telemetry.sTyreTemp[0] +
      this.telemetry.sTyreTemp[1] +
      this.telemetry.sTyreTemp[2] +
      this.telemetry.sTyreTemp[3];
  ...
  showBrakeTemp = (onRight) => {
    ...
    const brakeTemps =
      this.telemetry.sBrakeTempCelsius[0] +
      this.telemetry.sBrakeTempCelsius[1] +
      this.telemetry.sBrakeTempCelsius[2] +
      this.telemetry.sBrakeTempCelsius[3];
  ...
  showCurrentLap = (onRight) => {
    ...
    this.tmBtLed.setTime(
      this.timings.sCurrentTime >= 0 ? this.timings.sCurrentTime * 1000 : 0,
      onRight,
    );
  };
  showLastLap = (onRight) => {
